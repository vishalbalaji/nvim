...
cmd("autocmd VimEnter * hi! link GitSignsAdd GruvboxGreenBold")
cmd("autocmd VimEnter * hi! link GitSignsChange GruvboxYellowBold")
cmd("autocmd VimEnter * hi! link GitSignsDelete GruvboxRedBold")
